...
当前多用户智能体的登录、账号管理、模型配置、Credit 和迁移说明见 [管理与部署](docs/admin-credit-deployment.md)，研究及论文导出见 [实现与复现](docs/agent-implementation.md)。正式环境为 `server-shu`，功能分支经 PR 审阅并合入 `main` 后再自动更新。
